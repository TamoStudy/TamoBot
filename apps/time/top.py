...
class Top():
    ...
    def display_top(self, interaction: discord.Interaction) -> discord.Embed:
        ...
        embed.add_field(name='\u200b', value='<:myemote:1097295903506829342> Leaderboard resets monthly relative to UTC.\n<:myemote:1097295903506829342> :first_place: **First** at the end of the month receives\n200 <:customEmote:1096777370318413954> Tamo tokens and\n<@&849134842814005279> for the following month!\n<:myemote:1097295903506829342> :second_place: **Second** at the end of the month receives\n100 <:customEmote:1096777370318413954> Tamo tokens.\n<:myemote:1097295903506829342> :third_place: **Third** at the end of the month receives\n50 <:customEmote:1096777370318413954> Tamo tokens.', inline=False)
